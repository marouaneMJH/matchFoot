...
$lineups = LineupController::getLineupsByMatchId($match_id);
// var_dump($lineups);
// die();
      ...
      <div class="card-header bg-green-50 flex justify-between items-center">
        <div>
          ...
          <p class="text-gray-500 text-sm mt-1">
            ...
            <?php echo $homeTeamPlayers[0]['club_name'] . ' VS ' . $awayTeamPlayers[0]['club_name'] . ' | ' . $match[GameMatch::$date] . ' | '
              . $match[GameMatch::$time] . ' | ' . $homeTeamPlayers[0]['stadium_name'] ?>
          </p>
        </div>
        <span class="badge badge-green">Round <?php echo $match[GameMatch::$round] ?></span>
      </div>
    </div>
          ...
          <div class="card">
            <div class="card-header bg-blue-50">
              <h2 class="text-blue-800 font-bold flex items-center">
                <i class="fas fa-user-circle mr-2"></i> <?php echo $homeTeamPlayers[0]['club_name'] ?>
              </h2>
          ...
          <div class="card">
            <div class="card-header bg-red-50">
              <h2 class="text-red-800 font-bold flex items-center">
                <i class="fas fa-user-circle mr-2"></i> <?php echo $awayTeamPlayers[0]['club_name'] ?>
              </h2>
              <div class="text-sm text-gray-500 mt-1 flex space-x-2">
