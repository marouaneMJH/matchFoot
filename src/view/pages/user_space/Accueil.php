  ...
  <body>
    ...
    <main>
      <aside class="sidebar">
        <h2>MENU</h2>
        <ul id="menu">
          <li data-content="accueil" class="active">
            <i class="fas fa-home"></i> Accueil
          </li>
          <li data-content="classement">
            <i class="fas fa-list"></i> Classement
          </li>
          <li data-content="actualite">
            <i class="fas fa-newspaper"></i> Actualité
          </li>
          <li data-content="sondage"><i class="fas fa-poll"></i> Sondage</li>
        ...
        <ul>
          ...
          <li>
            <img
              src="../../assets/images/equipes_logo/BOTOLA PRO 2_logo.png"
              alt="Botola Pro 2"
            />
            Botola Pro inwi 2
          </li>
          <li>
            <img
              src="../../assets/images/equipes_logo/Coupe du throne.jpeg"
              alt="Coupe du Throne"
            />
            Coupe du Throne
          </li>
          <li>
            <img
              src="../../assets/images/equipes_logo/Excellence cup.jpeg"
              alt="Coupe d'excellence"
            />
            Coupe d'excellence
          </li>
        </ul>
